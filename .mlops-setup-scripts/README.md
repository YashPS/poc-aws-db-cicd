...
* Be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://dbc-38930770-d64f.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-38930770-d64f.cloud.databricks.com#setting/accounts). If
...
* Configure a Databricks CLI profile for your staging workspace by running
  ``databricks configure --token --profile "my-mlops-project-staging" --host https://dbc-38930770-d64f.cloud.databricks.com``, 
...
* Create a [Databricks REST API token](https://docs.databricks.com/dev-tools/api/latest/authentication.html#generate-a-personal-access-token)
  in the staging workspace ([link](https://dbc-38930770-d64f.cloud.databricks.com#setting/account))
  and paste the value into the prompt.
* Configure a Databricks CLI for your prod workspace by running ``databricks configure --token --profile "my-mlops-project-prod" --host https://dbc-38930770-d64f.cloud.databricks.com``
* Create a Databricks REST API token in the prod workspace ([link](https://dbc-38930770-d64f.cloud.databricks.com#setting/account)).
  and paste the value into the prompt
...
by checking for the group in the [staging workspace admin console](https://dbc-38930770-d64f.cloud.databricks.com#setting/accounts/groups) and
[prod workspace admin console](https://dbc-38930770-d64f.cloud.databricks.com#setting/accounts/groups).
